        ...
        switch ($_POST['action']) {
            case 'add':
                try {
                    ...
                    // Insert new user
                    $stmt = $pdo->prepare("INSERT INTO users (username, email, password, role, status, created_at) VALUES (?, ?, ?, 'student', 'active', NOW())");
                    $stmt->execute([
                        $_POST['username'],
                        $_POST['email'],
                        $hashed_password
            ...
            case 'edit':
                try {
                    ...
                    // Update user
                    $update_query = "UPDATE users SET username = ?, email = ?, status = ?, updated_at = NOW()";
                    $params = [$_POST['username'], $_POST['email'], $_POST['status'], $_POST['user_id']];
                    
                    // If password is provided, update it too
                    if (!empty($_POST['password'])) {
                        $hashed_password = password_hash($_POST['password'], PASSWORD_DEFAULT);
                        $update_query .= ", password = ?";
                        $params = [$_POST['username'], $_POST['email'], $_POST['status'], $hashed_password, $_POST['user_id']];
                    }
...
try {
    ...
    $stats = ['total_student_users' => 0, 'active_users' => 0, 'inactive_users' => 0, 'pending_users' => 0, 'users_with_records' => 0];
}
?>
...
<head>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2><i class="fas fa-users me-2"></i>Manage Student Users</h2>
                        ...
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4><?php echo $stats['total_student_users']; ?></h4>
                        ...
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4><?php echo $stats['users_with_records']; ?></h4>
                                    <p class="mb-0">With Student Records</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4><?php echo $stats['pending_users']; ?></h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-user-plus me-2"></i>Add New Student User</h5>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Student User</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form method="POST">
                    <div class="modal-body">
